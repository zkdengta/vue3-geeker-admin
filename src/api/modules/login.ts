...
export const loginApi = (params: Login.ReqLoginForm) => {
	...
	return http.post<Login.ResLogin>(PORT1 + `/login`, params, { isShowLoading: true }); // 正常 post json 请求  ==>  application/json
...
export const getAuthButtonListApi = () => {
	return http.get<Login.ResAuthButtons>(PORT1 + `/auth/buttons`, {}, { isShowLoading: true });
